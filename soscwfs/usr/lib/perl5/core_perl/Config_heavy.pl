...
## Target system     : linux build-3-22-aarch64 6.1.90-0-lts #1-alpine smp mon, 06 may 2024 08:14:42 +0000 aarch64 linux 
#
...
incpath=''
incpth='/usr/include/fortify /usr/include /usr/lib/gcc/aarch64-alpine-linux-musl/14.2.0/include'
inews=''
...
mydomain='.local'
myhostname='build-3-22-aarch64'
myuname='linux build-3-22-aarch64 6.1.90-0-lts #1-alpine smp mon, 06 may 2024 08:14:42 +0000 aarch64 linux '
n='-n'
need_va_copy='undef'
