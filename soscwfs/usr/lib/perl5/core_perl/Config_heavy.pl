...
## Package name      : perl5
## Source directory  : .
## Configuration time: Wed Apr 17 13:31:36 UTC 2024
## Configured by     : Alpine
## Target system     : linux build-3-20-aarch64 6.1.34-1-lts #2-alpine smp thu, 15 jun 2023 03:51:44 +0000 aarch64 linux 
#
...
ccversion=''
cf_by='Alpine'
cf_email='Alpine@build-3-20-aarch64.local'
cf_time='Wed Apr 17 13:31:36 UTC 2024'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg14='-Doptimize=-Os -fstack-clash-protection -Wformat -Werror=format-security -O2'
...
config_arg26='-Ud_csh'
config_arg27='-Ud_fpos64_t'
config_arg28='-Ud_off64_t'
config_arg29='-Dusenm'
...
mydomain='.local'
myhostname='build-3-20-aarch64'
myuname='linux build-3-20-aarch64 6.1.34-1-lts #2-alpine smp thu, 15 jun 2023 03:51:44 +0000 aarch64 linux '
n='-n'
need_va_copy='undef'
...
perladmin='Alpine@build-3-20-aarch64.local'
