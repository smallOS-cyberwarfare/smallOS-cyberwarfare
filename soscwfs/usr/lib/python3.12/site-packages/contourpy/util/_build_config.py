...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/home/buildozer/aports/community/py3-contourpy/src/contourpy-1.3.1/.mesonpy-csloxof2/lib/contourpy/util",
        source_dir=r"/home/buildozer/aports/community/py3-contourpy/src/contourpy-1.3.1/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/home/buildozer/aports/community/py3-contourpy/src/contourpy-1.3.1/.mesonpy-csloxof2/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
