...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 782,      /* -Wpoison-system-directories */
  ...
  OPT_mbig_endian = 1971,                    /* -mbig-endian */
  OPT_mbionic = 1972,                        /* -mbionic */
  OPT_mbranch_protection_ = 1973,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1974,                       /* -mcmodel= */
  OPT_mcpu_ = 1975,                          /* -mcpu= */
  OPT_mearly_ldp_fusion = 1976,              /* -mearly-ldp-fusion */
  OPT_mearly_ra_ = 1977,                     /* -mearly-ra= */
  OPT_mfix_cortex_a53_835769 = 1978,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1979,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1980,             /* -mgeneral-regs-only */
  OPT_mglibc = 1981,                         /* -mglibc */
  OPT_mharden_sls_ = 1982,                   /* -mharden-sls= */
  OPT_mlate_ldp_fusion = 1983,               /* -mlate-ldp-fusion */
  OPT_mlittle_endian = 1984,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1985,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1986,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1987,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1988,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1989,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1990,               /* -moutline-atomics */
  OPT_moverride_ = 1991,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1992,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1993,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1994, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1995,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1996,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1997,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1998,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1999,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 2000,                     /* -mtls-size= */
  OPT_mtp_ = 2001,                           /* -mtp= */
  OPT_mtrack_speculation = 2002,             /* -mtrack-speculation */
  OPT_mtune_ = 2003,                         /* -mtune= */
  OPT_muclibc = 2004,                        /* -muclibc */
  OPT_mverbose_cost_dump = 2005,             /* -mverbose-cost-dump */
  OPT_n = 2006,                              /* -n */
  OPT_name_sort = 2007,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2008,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2009,              /* -no-integrated-cpp */
  OPT_no_pie = 2010,                         /* -no-pie */
  OPT_nocpp = 2011,                          /* -nocpp */
  OPT_nodefaultlibs = 2012,                  /* -nodefaultlibs */
  OPT_nolibc = 2013,                         /* -nolibc */
  OPT_nophoboslib = 2014,                    /* -nophoboslib */
  OPT_nostartfiles = 2015,                   /* -nostartfiles */
  OPT_nostdinc = 2016,                       /* -nostdinc */
  OPT_nostdinc__ = 2017,                     /* -nostdinc++ */
  OPT_nostdlib = 2018,                       /* -nostdlib */
  OPT_nostdlib__ = 2019,                     /* -nostdlib++ */
  OPT_o = 2020,                              /* -o */
  OPT_objects = 2021,                        /* -objects */
  OPT_p = 2022,                              /* -p */
  OPT_pass_exit_codes = 2023,                /* -pass-exit-codes */
  /* OPT_pedantic = 2024, */                 /* -pedantic */
  OPT_pedantic_errors = 2025,                /* -pedantic-errors */
  OPT_pg = 2026,                             /* -pg */
  OPT_pie = 2027,                            /* -pie */
  OPT_pipe = 2028,                           /* -pipe */
  OPT_posix = 2029,                          /* -posix */
  OPT_print_file_name_ = 2030,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2031,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2032,          /* -print-multi-directory */
  OPT_print_multi_lib = 2033,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2034,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2035,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2036,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2037,               /* -print-prog-name= */
  OPT_print_search_dirs = 2038,              /* -print-search-dirs */
  OPT_print_sysroot = 2039,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2040,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2041,                    /* -print-value */
  OPT_profile = 2042,                        /* -profile */
  OPT_pthread = 2043,                        /* -pthread */
  OPT_quiet = 2044,                          /* -quiet */
  OPT_r = 2045,                              /* -r */
  OPT_rdynamic = 2046,                       /* -rdynamic */
